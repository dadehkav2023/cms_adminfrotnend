...
import Styles from "./AlterPhotoNews.module.scss";
...
import { UseDeletePhotoNews } from "../../../../../core/services/api/delete-photo-news.api";
import { UseEditPhotoNews } from "../../../../../core/services/api/edit-photo-news.api";
import { UseGetPhotoNews } from "../../../../../core/services/api/get-photo-news.api";
import { UseAddPhotoNewsAttachment } from "../../../../../core/services/api/add-photo-news-attachment.api";
import { UseDeletePhotoNewsAttachment } from "../../../../../core/services/api/delete-photo-news-attachment.api";
import { UseEditPhotoNewsAttachment } from "../../../../../core/services/api/edit-photo-news-attachment.api";
import { UseGetPhotoNewsAttachments } from "../../../../../core/services/api/get-photo-news-attachments.api";
import { AddPhotoNewsAttachmentsModal } from "./AddPhotoNewsAttachmentsModal/AddPhotoNewsAttachmentsModal";
import { EditPhotoNewsAttachmentsModal } from "./EditPhotoNewsAttachmentsModal/EditPhotoNewsAttachmentsModal";
import { DeletePhotoNewsAttachmentsModal } from "./DeletePhotoNewsAttachmentsModal/DeletePhotoNewsAttachmentsModal";
...
export interface AlterPhotoNewsProps {}

const AlterPhotoNews: React.FC<AlterPhotoNewsProps> = () => {
  ...
  const onSubmit = (values: any) => {
    editMutate({
      ...values,
      Id: id,
      ImagePath: values.ImagePath ? values.ImagePath : null,
  ...
  return getIsLoading ||
    ...
    <div style={{ textAlign: "center" }}>
      ...
      <Redirect to="/NewsManagement/NewsList/PhotoNews" />
      <Link to="/NewsManagement/NewsList/PhotoNews">
    ...
    <>
      ...
      />
      <DeletePhotoNewsAttachmentsModal
        id={selectedId}
        isOpen={deleteIsOpen}
        modalToggled={() => {
      ...
      <DeleteNewsModal
        ...
        mutate={() => {
          deleteNewsMutate({ Id: id, ContentType: "2" });
        }}
          ...
          return (
            <FieldWrapper setFieldError={setFieldError} useMutate={() => {}}>
              <Form noValidate>
                ...
                <FormDivider textHeader="ویرایش خبر">
                  <TwoColumn>
                    <div>
                      <TextInput
                        lableText="تیتر خبر"
