...
const PhotoNewsList: React.FC<PhotoNewsListProps> = () => {
  ...
  const { data, isError, isLoading, isSuccess, mutate } = UseGetPhotoNews();
                    ...
                    <Row key={index}>
                      ...
                      <Col xs={3}>
                        <div className={Styles.buttonDiv}>
                          <Link
                            to={
                              "/NewsManagement/AlterNews/PhotoNews/" + item.id
                            }
                          >
                            <SimpleSubmitButton
                              isLoading={false}
