...
import {
  AddDownloadMenuValidate,
  AddMenuValidate,
} from "../../../../../core/validations/add-menu.validations";
interface AddDownloadMenuProps {}
interface Iparents {
  value: number;
  label: string;
}

const AddDownloadMenu: React.FC<AddDownloadMenuProps> = () => {
  ...
  const onSubmit = (values: any) => {
    PostMutate({
      ...
      File: values.File[0] ? values.File[0] : null,
  ...
  return getIsLoading || PostIsLoading ? (
    ...
    <>
      <Formik
        ...
        validationSchema={AddDownloadMenuValidate}
