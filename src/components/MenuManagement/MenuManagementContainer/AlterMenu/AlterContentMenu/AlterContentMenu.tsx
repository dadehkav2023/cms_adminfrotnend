...
import Styles from "./AlterContentMenu.module.scss";
...
import { EditContentMenuValidate } from "../../../../../core/validations/edit-menu.validations";
import { UseGetMenuById } from "../../../../../core/services/api/get-menu-by-id.api";

export interface AlterContentMenuProps {}

const AlterContentMenu: React.FC<AlterContentMenuProps> = () => {
    ...
    if (!menu.menuItem) {
      ...
      menu.id === +id &&
        setInitialValues({
          ...initialValues,
          Title: menu.title,
          Content: menu.menuItem.ckEditorText,
  ...
  return getIsLoading ||
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={EditContentMenuValidate}
