...
import Styles from "./AlterLinkMenu.module.scss";
...
import { EditLinkMenuValidate } from "../../../../../core/validations/edit-menu.validations";
import { UseGetMenuById } from "../../../../../core/services/api/get-menu-by-id.api";

export interface AlterLinkMenuProps {}

const AlterLinkMenu: React.FC<AlterLinkMenuProps> = () => {
  ...
  return getIsLoading ||
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={EditLinkMenuValidate}
