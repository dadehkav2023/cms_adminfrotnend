...
import Styles from "./AlterModuleMenu.module.scss";
...
import { siteModules } from "../../../../../core/enums/site-modules";
import { EditModuleMenuValidate } from "../../../../../core/validations/edit-menu.validations";
import { UseGetMenuById } from "../../../../../core/services/api/get-menu-by-id.api";

export interface AlterModuleMenuProps {}

const AlterModuleMenu: React.FC<AlterModuleMenuProps> = () => {
  ...
  const [initialValues, setInitialValues] = useState({
    ...
    IconPath: null,
    ModularPage: { value: 0, label: "انتخاب کنید" },
  });
  ...
  const onSubmit = (values: any) => {
    editMutate({
      ...
      ModularPage: values.ModularPage.value,
  ...
  return getIsLoading ||
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={EditModuleMenuValidate}
