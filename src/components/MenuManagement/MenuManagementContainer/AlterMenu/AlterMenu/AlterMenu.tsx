...
import Styles from "./AlterMenu.module.scss";
...
import { EditMenuValidate } from "../../../../../core/validations/edit-menu.validations";
import {
  UseGetMenuById,
  UseGetRootMenuById,
} from "../../../../../core/services/api/get-menu-by-id.api";

export interface AlterMenuProps {}

const AlterMenu: React.FC<AlterMenuProps> = () => {
  ...
  const onSubmit = (values: any) => {
    editMutate({
      ...values,
      Id: +id,
      Icon: values.Icon[0] ? values.Icon[0] : null,
  ...
  return getIsLoading ||
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={EditMenuValidate}
