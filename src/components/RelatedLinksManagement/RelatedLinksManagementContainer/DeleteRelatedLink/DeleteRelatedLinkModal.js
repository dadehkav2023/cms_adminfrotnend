...
import Styles from "./DeleteRelatedLinkModal.module.scss";
import { FallBackSpinner } from "../../../common/Spinner/FallBackSpinner/FallbackSpinner";
import { TwoColumn } from "../../../common/Wrapper/ColumnWrapper/TwoColumn/TwoColumn";
const DeleteRelatedLinkModal = ({
  id,
  isOpen,
  modalToggled,
  loading,
  ...
  return loading ? (
    ...
    >
      <Formik
        ...
        //validationSchema={EditRelatedLinkValidation}
      >
        {({ params, values }) => {
          return (
            <Form>
