      ...
      Data.forEach((row: any) => {
        newTable.push({
          ...
          workPositionTitle: row.workPosition
            ? fullOption(row.workPosition.toString(), workplaceOptions).labe
            : "",
                            ...
                            <Row>
                              <Col>
                                <BasicSelectOption
                                  ...
                                  lableText="گواهی مهارت از سازمان محل خدمت"
                                  significant
                                />
                              </Col>
                            </Row>
                            ...
                            <Row>
                              <Col>
                                <BasicSelectOption
                                  ...
                                  placeHolder="انتخاب سازمان محل کار"
                                  lableText="سازمان محل کار"
                                  significant
                                />
                              </Col>
                            </Row>
