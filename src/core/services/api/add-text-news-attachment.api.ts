...
const url = MainUrl + "/api/News/TextNews/Attachment/NewAttachment";

const AddTextNewsAttachmentApi = async (
  value: any
...
export const UseAddTextNewsAttachment = () => {
  // const history = useHistory();
  return useMutation((obj: any) => AddTextNewsAttachmentApi(obj), {
    onSuccess: (value) => {
      value.data
