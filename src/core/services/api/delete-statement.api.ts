...
const url = MainUrl + "/api/admin/Statement/DeleteStatement";

const DeleteStatementApi = async (
  value: any
...
export const UseDeleteStatement = () => {
  ...
  return useMutation((obj: any) => DeleteStatementApi(obj), {
    onSuccess: (value) => {
      value.data
        ? showToast([" بیانیه با موفقیت حذف شد"], "success")
