...
const url = MainUrl + "/api/admin/Statement/Category/NewCategory";

const AddStatementCategoryApi = async (
  value: any
...
export const UseAddStatementCategory = () => {
  // const history = useHistory();
  return useMutation((obj: any) => AddStatementCategoryApi(obj), {
    onSuccess: (value) => {
      value.data
