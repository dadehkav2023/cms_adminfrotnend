...
const url = MainUrl + "/api/admin/Statement/Attachment/EditAttachment";

const EditStatementAttachmentApi = async (
  value: any
...
export const UseEditStatementAttachment = () => {
  const history = useHistory();
  return useMutation((obj: any) => EditStatementAttachmentApi(obj), {
    onSuccess: (value) => {
      value.data
