...
const url = MainUrl + "/api/admin/Slider/EditSlider";
...
const EditSlideApi = async (
  ...
  formOfValues.set("SliderFile", value.SliderFile ? value.SliderFile : null);
...
export const UseEditSlide = () => {
  ...
  return useMutation((obj: any) => EditSlideApi(obj), {
    onSuccess: (value) => {
      value.data
