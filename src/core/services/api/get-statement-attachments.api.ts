...
const url = MainUrl + "/api/admin/Statement/Attachment/GetAttachment";

const GetStatementAttachmentsApi = async (
  value: any
...
export const UseGetStatementAttachments = () => {
  ...
  return useMutation((obj: any) => GetStatementAttachmentsApi(obj), {});
};
